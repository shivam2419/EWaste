...
urlpatterns = [
    ...
    path('api/order-details/<int:user_id>/', views.getAllAcceptedOrders, name='order-details'), 
    path('api/all-order-details/<int:user_id>/', views.getAllOrders, name='order-details'), 
